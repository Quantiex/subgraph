...
export class BToken extends ethereum.SmartContract {
  ...
  try_burn(amt: BigInt): ethereum.CallResult<boolean> {
  ...
  mint(dst: Address, amt: BigInt): boolean {
  ...
  try_mint(dst: Address, amt: BigInt): ethereum.CallResult<boolean> {
